...
my_data<-(read.csv("C:/Users/Hanna/OneDrive/Internship_RUB/SHEZOOFUNS_Rotifer/LT1_S1_09_08_2023.csv"))
...
setwd('/Users/Hanna/OneDrive/Internship_RUB/SHEZOOFUNS Rotifer Samples') #change this to the directory where your dataset is saved 
